...
IL_00dc:
	{
		...
		NullCheck(L_38);
		bool L_39;
		L_39 = VirtualFuncInvoker0< bool >::Invoke(201, L_38);
		V_8 = L_39;
		bool L_40 = V_8;
		if (!L_40)
		{
...
IL_02f1:
	{
		...
		NullCheck(L_126);
		bool L_129;
		L_129 = VirtualFuncInvoker1< bool, Type_t* >::Invoke(167, L_126, L_128);
		V_21 = L_129;
		bool L_130 = V_21;
		if (!L_130)
		{
...
IL_02f1:
	{
		...
		NullCheck(L_134);
		bool L_137;
		L_137 = VirtualFuncInvoker1< bool, Type_t* >::Invoke(167, L_134, L_136);
		V_21 = L_137;
		bool L_138 = V_21;
		if (!L_138)
		{
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR bool TypeConversion_TryConvertToUnityEngineObject_TisDouble_tE150EF3D1D43DEE85D533810AB4C742307EEDE5F_TisBoolean_t09A6377A54BE2F9E6985A8149F19234FD7DDFE22_m3292CD5BE79BE16D002B78BE4B32B1BAF0C5DD35_gshared (double ___0_source, bool* ___1_destination, const RuntimeMethod* method) 
{
	...
	int32_t G_B5_0 = 0;
	{
		...
		NullCheck(L_1);
		bool L_4;
		L_4 = VirtualFuncInvoker1< bool, Type_t* >::Invoke(167, L_1, L_3);
...
IL_0030:
	{
		...
		NullCheck(L_8);
		bool L_11;
		L_11 = VirtualFuncInvoker1< bool, Type_t* >::Invoke(167, L_8, L_10);
		if (L_11)
		{
			goto IL_005b;
		}
